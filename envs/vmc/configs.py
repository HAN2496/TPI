...
class Search_config(Parameters):
    ...
    p: dict = field(default_factory=lambda:{"range": (37, 371), "coarse_step": 18, "fine_range": 18})
    lqr: dict = field(default_factory=lambda: {"range": (748, 7483), "coarse_step": 374, "fine_range": 374})
    mpc: dict = field(default_factory=lambda: {"range": (748, 7483), "coarse_step": 374, "fine_range": 374})
    mpc_2: dict = field(default_factory=lambda: {"range": (780, 7800), "coarse_step": 390, "fine_range": 390})
