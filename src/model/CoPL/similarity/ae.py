...
class AESimilarity(ItemSimilarityBuilder):
    ...
    def visualize(self, save_dir, item_series, item_owner_uid,
        ...
        from ..visualization import (plot_vae_reconstruction, plot_vae_feature_mse,
        ...
        _paper_labels = ["VerAccel", "PitchRate", "BounceRate", "LongAccel"]
        plot_ae_orig_paper(self.ae, item_series, _paper_labels,
                           self.mu_stats, self.sd_stats, save_dir / "ae_orig_paper.png")
        plot_ae_recon_paper(self.ae, item_series, _paper_labels,
