...
class RegressionTrainer:
    ...
    def _preprocess_loader(self, data_loader):
        X_list, y_list = [], []
    ...
    def train(self, train_loader, val_loader, **kwargs):
        X_train, y_train = self._preprocess_loader(train_loader)
        X_val, y_val = self._preprocess_loader(val_loader)

        self.model.fit(X_train, y_train)
        val_auroc = roc_auc_score(y_val, self.model.predict_proba(X_val))
        return {}, val_auroc
