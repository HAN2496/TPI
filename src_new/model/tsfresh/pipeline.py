...
class TSFreshPipeline(BaseEstimator, TransformerMixin):
    def __init__(self, feature_names, n_components=2, extraction_settings=None, verbose=0):
        ...
        elif extraction_settings in ('efficient', None):
    ...
    def _extract(self, X):
        ...
        X_extracted = extract_features(
            ...
            n_jobs=0, disable_progressbar=(self.verbose < 1))
        impute(X_extracted)
        return X_extracted
    ...
    def fit(self, X, y=None):
        ...
        self.pca.fit(self.scaler.transform(X_sel))
    ...
    def transform(self, X):
        ...
        return self.pca.transform(self.scaler.transform(X_sel))
