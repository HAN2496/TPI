...
from src.data.splits import load_sequences
from src.model.copl.similarity.vae import Conv1dVAE
from src.model.copl.similarity.ae import Conv1dAE
...
def load_data(cfg):
    ...
    for i, drv in enumerate(cfg.train_drivers):
        X, y = load_sequences(drv, cfg.features, cfg.time_range, cfg.downsample,
    ...
    X_te, y_te = load_sequences(cfg.test_driver, cfg.features, cfg.time_range, cfg.downsample,
                                 smooth=cfg.smooth, smooth_cutoff=cfg.smooth_cutoff, smooth_order=cfg.smooth_order)
...
def main():
    ...
    plot_recon_per_feature(metrics, cfg.features, out_dir)
